# manage-disputes Edge Function

Complete dispute management with automated email and SMS notifications to investors.
...
1. **New Dispute Created**: Email + SMS to investor confirming receipt
2. **Status Change**: Email + SMS to investor when status changes
3. **Staff Response**: Email + SMS to investor when staff sends a non-internal message
