# investor-favorites Edge Function

Manages investor saved/favorite properties.
...
CREATE INDEX idx_investor_favorites_investor ON investor_favorites(investor_id);
CREATE UNIQUE INDEX idx_investor_favorites_unique ON investor_favorites(investor_id, property_id);
```
