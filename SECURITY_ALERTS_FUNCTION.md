...
Manages security alerts for investor accounts, including fetching alerts, updating settings, and clearing known devices.
...
- `RESEND_API_KEY` - For sending security alert emails

## Deployment

```bash
supabase functions new security-alerts
# Copy code to supabase/functions/security-alerts/index.ts
