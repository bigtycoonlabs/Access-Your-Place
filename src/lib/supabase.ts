...
function safeRealtimeDecode(
  ...
  try {
    // â”€â”€ Binary (ArrayBuffer) messages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ String (JSON) messages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (typeof rawMessage === 'string') {
      let parsed: unknown;
      try {
        parsed = JSON.parse(rawMessage);
      } catch {
        // Not valid JSON â€“ nothing we can do
      ...
      // Primitive value (number, boolean, null) â€“ shouldn't happen but be safe
      return callback({});
    }

    // â”€â”€ Anything else (Blob, null, undefined) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    return callback({});
  } catch (err) {
...
// â”€â”€ Safety-net global error handlers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  try {
    ...
    const res = await fetch(url, {
      ...
      headers: {
        ...
        // Intentionally NO content-type header â€” this avoids the Fastify error
      },
    });
    if (!res.ok) {
