...
function buildDbUrl(path) {
  ...
  // Railway PostgREST exposes tables at root:
  //   http://postgrest.railway.internal:3000/staff_users
  // Supabase exposes tables under /rest/v1:
  //   https://project.supabase.co/rest/v1/staff_users
