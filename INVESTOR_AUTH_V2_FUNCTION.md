# investor-auth-v2 Edge Function

Complete investor authentication system with session management, email verification, security alerts, and multi-device support.
...
1. Create the edge function in Supabase Dashboard or via CLI:
   ```bash
   supabase functions new investor-auth-v2
   ```

2. Copy the code above into `supabase/functions/investor-auth-v2/index.ts`
...
POST /investor-auth-v2
{
  ...
  "full_name": "John Doe",
  "phone": "5551234567",
  "referral_code": "AYP123ABC",
  "base_url": "https://accessyourplace.com"
}
```
