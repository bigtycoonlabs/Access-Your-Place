# manage-market-reports Edge Function
...
CREATE TABLE IF NOT EXISTS report_templates (
  ...
  colors JSONB DEFAULT '{"primary":"#1a365d","secondary":"#d4a574","accent":"#2d4a7c"}',
  branding JSONB DEFAULT '{"logo_url":null,"company_name":"","tagline":""}',
  data_points TEXT[] DEFAULT '{}',
  is_default_weekly BOOLEAN DEFAULT FALSE,
  is_default_monthly BOOLEAN DEFAULT FALSE,
  is_active BOOLEAN DEFAULT TRUE,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

CREATE TABLE IF NOT EXISTS investor_widget_settings (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
