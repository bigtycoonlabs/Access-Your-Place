...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const denied = await gate(req, body, String(body?.action || ''), corsHeaders, { publicActions: ['submit_support_request'], clientActions: ['get_conversation', 'get_unread_count', 'mark_all_read', 'send_reply'], ownRow: {} });
