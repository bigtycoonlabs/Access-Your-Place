...
Deno.serve(async (req) => {
  ...
  try {
    ...
    { const denied = await gate(req, __body, String(__body?.action || ''), corsHeaders, {"clientActions": ["generate_report", "get_preferences", "get_reports", "send_report_email", "update_preferences"]});
