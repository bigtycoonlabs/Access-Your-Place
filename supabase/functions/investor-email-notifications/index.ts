...
Deno.serve(async (req) => {
  ...
  try {
    ...
    { const denied = await gate(req, body, String(body?.action || ''), corsHeaders, {"publicActions": ["verify_token", "unsubscribe", "resubscribe"], "clientActions": ["get_email_history", "get_preferences", "update_preferences"]});
