...
Deno.serve((req) => {
  ...
  console.error('weekly-market-data-refresh invoked after retirement — check the caller');

  return new Response(
    JSON.stringify({
      success: false,
      retired: true,
      error: 'weekly-market-data-refresh was retired on 2026-08-05. It produced fabricated market figures and must not be used. No replacement exists yet; market data requires a measured source.',
    }),
